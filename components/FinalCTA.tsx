...
const FinalCTA = () => {
  return (
    <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
      ...
      <Link
        href="/selling-plan"
        className="inline-block h-16 px-12 text-lg bg-secondary hover:bg-secondary/90 text-secondary-foreground font-bold shadow-xl hover:shadow-2xl transition-all rounded-md leading-[4rem]"
      >
