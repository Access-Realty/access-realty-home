          ...
          <nav aria-label="Geographic context" className="text-sm">
            <ol className="flex flex-wrap items-center gap-1.5 text-primary-foreground/60">
              ...
              <li className="before:content-['·'] before:mx-1.5">
                <Link href="/direct-list/home-values/fort-worth" className="hover:text-primary-foreground/90 transition-colors">Fort Worth</Link>
              </li>
              <li className="before:content-['·'] before:mx-1.5">
                <Link href="/direct-list/home-values/tarrant-county" className="hover:text-primary-foreground/90 transition-colors">Tarrant County</Link>
              </li>
            </ol>
          </nav>
        </div>
