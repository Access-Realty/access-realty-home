// ABOUTME: Get Started wizard client component — multi-step DirectList onboarding
...
export default function GetStartedContent() {
  ...
  return (
    <div className="bg-background">
      ...
      <Section variant="tight" maxWidth="2xl" borderTop className="text-center">
