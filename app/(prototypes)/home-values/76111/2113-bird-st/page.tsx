...
// ─── Nearby closed comps (plausible for 76111 northside Fort Worth) ───────────
const COMPS = [
  {
    address: "2208 Lincoln Ave",
    city: "Fort Worth",
    zip: "76111",
    list_price: 485000,
    sold_price: 478000,
    sold_date: "2025-07-18",
    living_area: 2240,
    bedrooms: 3,
    bathrooms: 3,
    year_built: 2019,
  ...
  {
    address: "2501 Ellis Ave",
    city: "Fort Worth",
    zip: "76111",
    list_price: 525000,
    sold_price: 515000,
    sold_date: "2025-08-11",
    living_area: 2380,
    bedrooms: 4,
    bathrooms: 3.5,
    year_built: 2020,
  ...
  {
    address: "1809 Lee Ave",
    city: "Fort Worth",
    zip: "76111",
    list_price: 295000,
    sold_price: 288000,
    sold_date: "2025-05-20",
    living_area: 1240,
    bedrooms: 2,
    bathrooms: 1,
    year_built: 1952,
...
export default function PropertyPage() {
  ...
  return (
    <div className="bg-background">
          ...
          <nav aria-label="Geographic context" className="text-sm">
            <ol className="flex flex-wrap items-center gap-1.5 text-primary-foreground/60">
              ...
              <li className="before:content-['·'] before:mx-1.5">
                <Link href="/prototypes/home-values/76111" className="hover:text-primary-foreground/90 transition-colors">76111</Link>
              </li>
              <li className="before:content-['·'] before:mx-1.5 text-primary-foreground/90">{p.street_address}</li>
              <li className="before:content-['·'] before:mx-1.5">
                <Link href="/prototypes/home-values/fort-worth" className="hover:text-primary-foreground/90 transition-colors">Fort Worth</Link>
              </li>
              <li className="before:content-['·'] before:mx-1.5">
      ...
      <Section variant="content" maxWidth="5xl">
        <h2 className="text-2xl font-bold text-foreground mb-4">Our Track Record in Fort Worth</h2>
        <p className="text-sm text-muted-foreground mb-6">
          Our team has closed transactions across Fort Worth and surrounding areas. Here&apos;s where we&apos;ve helped buyers and sellers.
        </p>
