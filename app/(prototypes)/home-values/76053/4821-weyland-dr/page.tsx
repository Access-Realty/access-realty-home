// ABOUTME: Prototype — SEO property page for 4821 Weyland Dr, Hurst TX
...
const PARCEL = {
  ...
  living_area_sqft: 2396,
  bedrooms: 4,
  bathrooms_full: 3,
  bathrooms_total: 3.0,
  stories: 2,
  lot_size_acres: 0.387,
  lot_size_sqft: 16875,
  year_built: 1962,
  subdivision_name: "Woodcrest Addition",
  garage: "Garage",
  garage_spaces: 2,
  ...
  assessed_land_value: 77188,
  assessed_improvement_value: 262812,
  market_total_value: 340000,
  tax_amount: 4809.11,
  tax_year: 2024,
  ...
  avm_low: 309357,
  avm_high: 474596,
  avm_confidence_score: 71,
  avm_as_of_date: "2025-10-29",
  last_sale_price: 303500,
  last_transfer_date: "2020-09-04",
  owner_occupied: true,
};
...
const MARKET_STATS = {
  ...
  median_price_change_yoy: 3.5,
  avg_dom: 27,
  months_of_supply: 2.4,
  pct_list_price_received: 97.8,
  active_inventory: 68,
  closed_last_30: 28,
  closed_last_90: 89,
};
...
export default async function PropertyPage() {
  const listings = await getClosedListingsNearby(32.834942, -97.194655)
  const p = PARCEL;
    ...
    <div className="bg-background">
          ...
          <nav aria-label="Geographic context" className="text-sm">
            <ol className="flex flex-wrap items-center gap-1.5 text-primary-foreground/60">
              ...
              <li className="before:content-['·'] before:mx-1.5">
                <Link href="/prototypes/home-values/76053" className="hover:text-primary-foreground/90 transition-colors">76053</Link>
              </li>
              <li className="before:content-['·'] before:mx-1.5 text-primary-foreground/90">{p.street_address}</li>
              <li className="before:content-['·'] before:mx-1.5">
                <Link href="/prototypes/home-values/hurst" className="hover:text-primary-foreground/90 transition-colors">Hurst</Link>
              </li>
              <li className="before:content-['·'] before:mx-1.5">
      ...
      <Section variant="content" maxWidth="5xl">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-card rounded-xl border border-border p-6">
            ...
            <dl className="space-y-3">
              {[
                ...
                ["Building Condition", p.building_condition],
              ].map(([label, value]) => (
          ...
          <div className="bg-card rounded-xl border border-border p-6">
            ...
            <div className="bg-muted rounded-lg p-4 mb-6">
              <h4 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">Last Sale</h4>
              <div className="flex justify-between items-baseline">
                <span className="text-sm text-muted-foreground">
                  {new Date(p.last_transfer_date).toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" })}
                </span>
      ...
      <Section variant="content" maxWidth="5xl">
        <div className="grid md:grid-cols-[1fr_360px] gap-8 items-center">
          <div>
            <h2 className="text-2xl font-bold text-foreground mb-2">Stay Informed on 76053</h2>
