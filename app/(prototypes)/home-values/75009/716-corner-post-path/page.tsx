...
const PARCEL = {
  id: "8a9f8f95-9933-4269-a275-c4d613c52e32",
...
export default async function PropertyPage() {
  const [nearbyListings, heroImage] = await Promise.all([
    getListingsNearby(33.272109, -96.793815),
    getPropertyHeroImage(PARCEL.id, 33.272109, -96.793815),
  ]);
  const p = PARCEL;
      ...
      <Section variant="tight" maxWidth="5xl">
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            { label: '75009', href: '/home-values/75009' },
            { label: 'Celina', href: '/home-values/celina' },
            { label: 'Collin County', href: '/home-values/collin-county' },
          ].map((link) => (
